  ...
  render() {
    return (
      <section className="about">
        ...
        <p>My job is to build your website so that it is functional and user-friendly but at the same time attractive. I use frameworks such as Bootstrap or Material UI.</p>
